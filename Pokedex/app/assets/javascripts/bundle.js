...
function (_React$Component) {
  ...
  _createClass(PokemonIndex, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "Inside Index"), this.props.pokemon.map(function (poke) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: new Date()
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, poke.name), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
          src: poke.image_url
        }));
      })));
    }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    requestAllPokemon: function requestAllPokemon() {
      return dispatch(_actions_pokemon_actions__WEBPACK_IMPORTED_MODULE_3__["requestAllPokemon"]);
    }
  };
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  store.dispatch(_actions_pokemon_actions__WEBPACK_IMPORTED_MODULE_5__["requestAllPokemon"]);
  window.getState = store.getState;
  window.dispatch = store.dispatch;
  window.requestAllPokemon = _actions_pokemon_actions__WEBPACK_IMPORTED_MODULE_5__["requestAllPokemon"];
